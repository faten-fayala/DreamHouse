...
const ProductItem = props => {
  return (
    ...
    //   <img className="img-product" src={props.product.Name} />
    ...
    <div class="product-card">
		...
		<div class="product-tumb">
			<img src={props.product.Name} alt=""/>
		</div>
		<div class="product-detail">
			<span class="product-catagory">{props.product.Marque}</span>
			<h4 ><a className="product-lien" href="">{props.product.Categorie}</a></h4>
			{/* <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero, possimus nostrum!</p> */}
			<div class="product-bottom-details">
				<div class="product-price">{props.product.Price} DT</div>
